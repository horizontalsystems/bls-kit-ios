 ...
 */
void ep_curve_get_v1(relic_bn_t v[]);

/**
 * Returns the parameter V2 of the prime curve.
 */
void ep_curve_get_v2(relic_bn_t v[]);
 ...
 */
void ep_curve_get_ord(relic_bn_t n);
 ...
 */
void ep_curve_get_cof(relic_bn_t h);
 ...
 */
void ep_curve_set_plain(const fp_t a, const fp_t b, const ep_t g, const relic_bn_t r,
		const relic_bn_t h, const fp_t u, int ctmap);
 ...
 * @param[in] ctmap	- true if this curve will use an isogeny for mapping.
 */
void ep_curve_set_super(const fp_t a, const fp_t b, const ep_t g, const relic_bn_t r,
		const relic_bn_t h, const fp_t u, int ctmap);
 ...
 * @param[in] ctmap	- true if this curve will use an isogeny for mapping.
 */
void ep_curve_set_endom(const fp_t a, const fp_t b, const ep_t g, const relic_bn_t r,
		const relic_bn_t h, const fp_t beta, const relic_bn_t l, const fp_t u, int ctmap);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_basic(ep_t r, const ep_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_slide(ep_t r, const ep_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_monty(ep_t r, const ep_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_lwnaf(ep_t r, const ep_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_lwreg(ep_t r, const ep_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_gen(ep_t r, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_fix_basic(ep_t r, const ep_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_fix_yaowi(ep_t r, const ep_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_fix_nafwi(ep_t r, const ep_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_fix_combs(ep_t r, const ep_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_fix_combd(ep_t r, const ep_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep_mul_fix_lwnaf(ep_t r, const ep_t *t, const relic_bn_t k);
 ...
 * @param[in] m				- the second integer,
 */
void ep_mul_sim_basic(ep_t r, const ep_t p, const relic_bn_t k, const ep_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void ep_mul_sim_trick(ep_t r, const ep_t p, const relic_bn_t k, const ep_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void ep_mul_sim_inter(ep_t r, const ep_t p, const relic_bn_t k, const ep_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void ep_mul_sim_joint(ep_t r, const ep_t p, const relic_bn_t k, const ep_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer.
 */
void ep_mul_sim_gen(ep_t r, const relic_bn_t k, const ep_t q, const relic_bn_t m);
