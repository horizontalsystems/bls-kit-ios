 ...
 */
void ep2_curve_get_vs(relic_bn_t *v);
 ...
 */
void ep2_curve_get_ord(relic_bn_t n);
 ...
 */
void ep2_curve_get_cof(relic_bn_t h);
 ...
 * @param[out] h			- the returned cofactor.
 */
void ep2_curve_get_s3(relic_bn_t s3);
 ...
 * @param[out] h			- the returned cofactor.
 */
void ep2_curve_get_s32(relic_bn_t s32);
 ...
 */
void ep2_curve_set(fp2_t a, fp2_t b, ep2_t g, relic_bn_t r, relic_bn_t h);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_basic(ep2_t r, ep2_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_slide(ep2_t r, ep2_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_monty(ep2_t r, ep2_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_lwnaf(ep2_t r, ep2_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_lwreg(ep2_t r, ep2_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_gen(ep2_t r, relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_fix_basic(ep2_t r, ep2_t *t, relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_fix_yaowi(ep2_t r, ep2_t *t, relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_fix_nafwi(ep2_t r, ep2_t *t, relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_fix_combs(ep2_t r, ep2_t *t, relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_fix_combd(ep2_t r, ep2_t *t, relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ep2_mul_fix_lwnaf(ep2_t r, ep2_t *t, relic_bn_t k);
 ...
 * @param[in] m				- the second integer,
 */
void ep2_mul_sim_basic(ep2_t r, ep2_t p, relic_bn_t k, ep2_t q, relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void ep2_mul_sim_trick(ep2_t r, ep2_t p, relic_bn_t k, ep2_t q, relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void ep2_mul_sim_inter(ep2_t r, ep2_t p, relic_bn_t k, ep2_t q, relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void ep2_mul_sim_joint(ep2_t r, ep2_t p, relic_bn_t k, ep2_t q, relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void ep2_mul_sim_gen(ep2_t r, relic_bn_t k, ep2_t q, relic_bn_t m);
