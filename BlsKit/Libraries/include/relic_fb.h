 ...
 * @param[in] b				- the exponent.
 */
void fb_exp_basic(fb_t c, const fb_t a, const relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fb_exp_slide(fb_t c, const fb_t a, const relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fb_exp_monty(fb_t c, const fb_t a, const relic_bn_t b);
