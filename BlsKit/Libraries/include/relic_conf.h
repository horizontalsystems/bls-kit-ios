...
#define relic_bn_MAGNI DOUBLE
/** Number of Karatsuba steps. */
#define relic_bn_KARAT 0
...
#define relic_bn_GEN   BASIC

/** Multiple precision arithmetic method */
#define relic_bn_METHD "COMBA;COMBA;MONTY;SLIDE;BASIC;BASIC"
