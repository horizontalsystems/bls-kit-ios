 ...
 */
void fp_prime_set_dense(const relic_bn_t p);
 ...
 */
void fp_prime_set_pairf(const relic_bn_t x, int pairf);
 ...
 */
void fp_prime_conv(fp_t c, const relic_bn_t a);
 ...
 */
void fp_prime_back(relic_bn_t c, const fp_t a);
 ...
 */
void fp_prime_get_par(relic_bn_t x);
 ...
 * @param[in] a				- the prime field element to invert.
 */
void fp_inv_exgcd_bn(relic_bn_t c, const relic_bn_t u, const relic_bn_t p);
 ...
 * @param[in] b				- the exponent.
 */
void fp_exp_basic(fp_t c, const fp_t a, const relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp_exp_slide(fp_t c, const fp_t a, const relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp_exp_monty(fp_t c, const fp_t a, const relic_bn_t b);
