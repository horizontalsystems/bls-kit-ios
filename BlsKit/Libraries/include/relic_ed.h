 ...
 */
void ed_curve_get_ord(relic_bn_t r);
 ...
 */
void ed_curve_get_cof(relic_bn_t h);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_fix_basic(ed_t r, const ed_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_fix_yaowi(ed_t r, const ed_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_fix_nafwi(ed_t r, const ed_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_fix_combs(ed_t r, const ed_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_fix_combd(ed_t r, const ed_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_fix_lwnaf(ed_t r, const ed_t *t, const relic_bn_t k);
 ...
 * @param[in] k       - the integer.
 */
void ed_mul_fix_lwnaf_mixed(ed_t r, const ed_t *t, const relic_bn_t k);
 ...
 * @param[in] k       - the integer.
 */
void ed_mul_gen(ed_t r, const relic_bn_t k);
 ...
 * @param[in] m       - the second integer,
 */
void ed_mul_sim_basic(ed_t r, const ed_t p, const relic_bn_t k, const ed_t q,
    const relic_bn_t m);
 ...
 * @param[in] m       - the second integer,
 */
void ed_mul_sim_trick(ed_t r, const ed_t p, const relic_bn_t k, const ed_t q,
    const relic_bn_t m);
 ...
 * @param[in] m       - the second integer,
 */
void ed_mul_sim_inter(ed_t r, const ed_t p, const relic_bn_t k, const ed_t q,
    const relic_bn_t m);
 ...
 * @param[in] m       - the second integer,
 */
void ed_mul_sim_joint(ed_t r, const ed_t p, const relic_bn_t k, const ed_t q,
    const relic_bn_t m);
 ...
 * @param[in] m       - the second integer.
 */
void ed_mul_sim_gen(ed_t r, const relic_bn_t k, const ed_t q, const relic_bn_t m);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_basic(ed_t r, const ed_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_slide(ed_t r, const ed_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_monty(ed_t r, const ed_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_lwnaf(ed_t r, const ed_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void ed_mul_lwreg(ed_t r, const ed_t p, const relic_bn_t k);
