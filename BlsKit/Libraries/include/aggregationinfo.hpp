...
class AggregationInfo {
 public:
    ...
    static AggregationInfo FromVectors(
                ...
                std::vector<relic_bn_t*> const &exponents);
    ...
    // Public accessors
    void GetExponent(relic_bn_t *result, const uint8_t* messageHash,
 ...
 private:
    ...
    // public keys (48) to exponents (relic_bn_t*).
    typedef std::map<uint8_t*, relic_bn_t*,
