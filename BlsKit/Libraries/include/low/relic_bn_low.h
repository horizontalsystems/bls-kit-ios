...
#ifndef RLC_relic_bn_LOW_H
#define RLC_relic_bn_LOW_H
...
#if (relic_bn_PRECI % WSIZE) > 0
#define RLC_relic_bn_DIGS		(relic_bn_PRECI/WSIZE + 1)
#else
#define RLC_relic_bn_DIGS		(relic_bn_PRECI/WSIZE)
#endif

#if relic_bn_MAGNI == DOUBLE
#define RLC_RELIC_BN_SIZE		(2 * RLC_relic_bn_DIGS + 2)
#elif relic_bn_MAGNI == CARRY
#define RLC_RELIC_BN_SIZE		((RLC_relic_bn_DIGS + 1)
#elif relic_bn_MAGNI == SINGLE
#define RLC_RELIC_BN_SIZE		(RLC_relic_bn_DIGS)
#endif
 ...
 */
dig_t relic_bn_add1_low(dig_t *c, const dig_t *a, const dig_t digit, const int size);
 ...
 * @return the carry of the last digit addition.
 */
dig_t relic_bn_addn_low(dig_t *c, const dig_t *a, const dig_t *b, int size);
 ...
 */
dig_t relic_bn_sub1_low(dig_t *c, const dig_t *a, dig_t digit, int size);
 ...
 * @return the carry of the last digit subtraction.
 */
dig_t relic_bn_surelic_bn_low(dig_t *c, const dig_t *a, const dig_t *b, int size);
 ...
 * @return relic_bn_LT if a < b, relic_bn_EQ if a == b and relic_bn_GT if a > b.
 */
int relic_bn_cmp1_low(dig_t a, dig_t b);
 ...
 * @return relic_bn_LT if a < b, relic_bn_EQ if a == b and relic_bn_GT if a > b.
 */
int relic_bn_cmpn_low(const dig_t *a, const dig_t *b, int size);
 ...
 */
dig_t relic_bn_lsh1_low(dig_t *c, const dig_t *a, int size);
 ...
 * @return the carry of the last digit shift.
 */
dig_t relic_bn_lshb_low(dig_t *c, const dig_t *a, int size, int bits);
 ...
 */
void relic_bn_lshd_low(dig_t *c, const dig_t *a, int size, int digits);
 ...
 * @return the carry of the last digit shift.
 */
dig_t relic_bn_rsh1_low(dig_t *c, const dig_t *a, int size);
 ...
 * @return the carry of the last digit shift.
 */
dig_t relic_bn_rshb_low(dig_t *c, const dig_t *a, int size, int bits);
 ...
 * @param[in] digits		- the shift amount.
 */
void relic_bn_rshd_low(dig_t *c, const dig_t *a, int size, int digits);
 ...
 */
dig_t relic_bn_mula_low(dig_t *c, const dig_t *a, dig_t digit, int size);
 ...
 */
dig_t relic_bn_mul1_low(dig_t *c, const dig_t *a, dig_t digit, int size);
 ...
 * @param[in] size			- the number of digits to multiply.
 */
void relic_bn_muln_low(dig_t *c, const dig_t *a, const dig_t *b, int size);
 ...
 */
void relic_bn_muld_low(dig_t *c, const dig_t *a, int sa, const dig_t *b, int sb,
		int low, int high);
 ...
 */
void relic_bn_sqra_low(dig_t *c, const dig_t *a, int size);
 ...
 */
void relic_bn_sqrn_low(dig_t *c, const dig_t *a, int size);
 ...
 */
void relic_bn_divn_low(dig_t *c, dig_t *d, dig_t *a, int sa, dig_t *b, int sb);
 ...
 */
void relic_bn_div1_low(dig_t *c, dig_t *d, const dig_t *a, int size, dig_t digit);
 ...
 */
void relic_bn_modn_low(dig_t *c, const dig_t *a, int sa, const dig_t *m, int sm,
	dig_t u);

#endif /* !ASM */

#endif /* !RLC_relic_bn_LOW_H */
