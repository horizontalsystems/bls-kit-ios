 ...
 */
void eb_curve_get_ord(relic_bn_t n);
 ...
 */
void eb_curve_get_cof(relic_bn_t h);
 ...
 */
void eb_curve_set(const fb_t a, const fb_t b, const eb_t g, const relic_bn_t n,
		const relic_bn_t h);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_basic(eb_t r, const eb_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_lodah(eb_t r, const eb_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_lwnaf(eb_t r, const eb_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_rwnaf(eb_t r, const eb_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_halve(eb_t r, const eb_t p, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_gen(eb_t r, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_fix_basic(eb_t r, const eb_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_fix_yaowi(eb_t r, const eb_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_fix_nafwi(eb_t r, const eb_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_fix_combs(eb_t r, const eb_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_fix_combd(eb_t r, const eb_t *t, const relic_bn_t k);
 ...
 * @param[in] k				- the integer.
 */
void eb_mul_fix_lwnaf(eb_t r, const eb_t *t, const relic_bn_t k);
 ...
 * @param[in] m				- the second integer,
 */
void eb_mul_sim_basic(eb_t r, const eb_t p, const relic_bn_t k, const eb_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void eb_mul_sim_trick(eb_t r, const eb_t p, const relic_bn_t k, const eb_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void eb_mul_sim_inter(eb_t r, const eb_t p, const relic_bn_t k, const eb_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer,
 */
void eb_mul_sim_joint(eb_t r, const eb_t p, const relic_bn_t k, const eb_t q,
		const relic_bn_t m);
 ...
 * @param[in] m				- the second integer.
 */
void eb_mul_sim_gen(eb_t r, const relic_bn_t k, const eb_t q, const relic_bn_t m);
