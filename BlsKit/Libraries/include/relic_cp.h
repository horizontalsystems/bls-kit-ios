 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_phpe_gen(relic_bn_t n, relic_bn_t l, int bits);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_phpe_enc(uint8_t *out, int *out_len, uint8_t *in, int in_len, relic_bn_t n);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_phpe_dec(uint8_t *out, int out_len, uint8_t *in, int in_len, relic_bn_t n,
		relic_bn_t l);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecdh_gen(relic_bn_t d, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecdh_key(uint8_t *key, int key_len, relic_bn_t d, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecmqv_gen(relic_bn_t d, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecmqv_key(uint8_t *key, int key_len, relic_bn_t d1, relic_bn_t d2, ec_t q2u,
		ec_t q1v, ec_t q2v);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecies_gen(relic_bn_t d, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecdsa_gen(relic_bn_t d, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecdsa_sig(relic_bn_t r, relic_bn_t s, uint8_t *msg, int len, int hash, relic_bn_t d);
 ...
 * @return a boolean value indicating if the signature is valid.
 */
int cp_ecdsa_ver(relic_bn_t r, relic_bn_t s, uint8_t *msg, int len, int hash, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecss_gen(relic_bn_t d, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ecss_sig(relic_bn_t e, relic_bn_t s, uint8_t *msg, int len, relic_bn_t d);
 ...
 * @return a boolean value indicating if the signature is valid.
 */
int cp_ecss_ver(relic_bn_t e, relic_bn_t s, uint8_t *msg, int len, ec_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_sokaka_gen(relic_bn_t master);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_sokaka_gen_prv(sokaka_t k, char *id, int len, relic_bn_t master);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ibe_gen(relic_bn_t master, g1_t pub);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_ibe_gen_prv(g2_t prv, char *id, int len, relic_bn_t master);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_bls_gen(relic_bn_t d, g2_t q);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_bls_sig(g1_t s, uint8_t *msg, int len, relic_bn_t d);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_bbs_gen(relic_bn_t d, g2_t q, gt_t z);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_bbs_sig(g1_t s, uint8_t *msg, int len, int hash, relic_bn_t d);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_cls_gen(relic_bn_t u, relic_bn_t v, g2_t x, g2_t y);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_cls_sig(g1_t a, g1_t b, g1_t c, uint8_t *msg, int len, relic_bn_t u, relic_bn_t v);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_cli_gen(relic_bn_t t, relic_bn_t u, relic_bn_t v, g2_t x, g2_t y, g2_t z);
...
int cp_cli_sig(g1_t a, g1_t A, g1_t b, g1_t B, g1_t c, uint8_t *msg, int len,
		relic_bn_t r, relic_bn_t t, relic_bn_t u, relic_bn_t v);
...
int cp_cli_ver(g1_t a, g1_t A, g1_t b, g1_t B, g1_t c, uint8_t *msg, int len,
		relic_bn_t r, g2_t x, g2_t y, g2_t z);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_clb_gen(relic_bn_t t, relic_bn_t u, relic_bn_t v[], g2_t x, g2_t y, g2_t z[], int l);
...
int cp_clb_sig(g1_t a, g1_t A[], g1_t b, g1_t B[], g1_t c, uint8_t *msgs[],
		int lens[], relic_bn_t t, relic_bn_t u, relic_bn_t v[], int l);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_pss_gen(relic_bn_t u, relic_bn_t v, g2_t g, g2_t x, g2_t y);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_pss_sig(g1_t a, g1_t b, uint8_t *msg, int len, relic_bn_t u, relic_bn_t v);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_psb_gen(relic_bn_t r, relic_bn_t s[], g2_t g, g2_t x, g2_t y[], int l);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_psb_sig(g1_t a, g1_t b, uint8_t *msgs[], int lens[], relic_bn_t r, relic_bn_t s[],
		int l);
 ...
 * @param[out] z			- the second component of the public key.
 */
int cp_zss_gen(relic_bn_t d, g1_t q, gt_t z);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_zss_sig(g2_t s, uint8_t *msg, int len, int hash, relic_bn_t d);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_vbnn_gen(relic_bn_t msk, ec_t mpk);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_vbnn_gen_prv(relic_bn_t sk, ec_t pk, relic_bn_t msk, uint8_t *id, int id_len);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_vbnn_sig(ec_t r, relic_bn_t z, relic_bn_t h, uint8_t *id, int id_len, uint8_t *msg,
		int msg_len, relic_bn_t sk, ec_t pk);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_vbnn_ver(ec_t r, relic_bn_t z, relic_bn_t h, uint8_t *id, int id_len, uint8_t *msg,
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_cmlhs_gen(relic_bn_t x[], gt_t hs[], int len, uint8_t prf[], int plen,
		relic_bn_t sk, g2_t pk, relic_bn_t d, g2_t y);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_cmlhs_sig(g1_t sig, g2_t z, g1_t a, g1_t c, g1_t r, g2_t s, relic_bn_t msg,
		char *data, int dlen, int label, relic_bn_t x, g1_t h,
		uint8_t prf[], int plen, relic_bn_t sk, relic_bn_t d);
...
int cp_cmlhs_ver(g1_t r, g2_t s, g1_t sig[], g2_t z[], g1_t a[], g1_t c[],
		relic_bn_t m, char *data, int dlen, int label[], g1_t h,
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_mklhs_gen(relic_bn_t sk, g2_t pk);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_mklhs_sig(g1_t s, relic_bn_t m, char *data, int dlen, char *label, int llen,
		relic_bn_t sk);
 ...
 * @return RLC_OK if no errors occurred, RLC_ERR otherwise.
 */
int cp_mklhs_fun(relic_bn_t mu, relic_bn_t m[], dig_t f[], int len);
 ...
 * @return a boolean value indicating the verification result.
 */
int cp_mklhs_ver(g1_t sig, relic_bn_t m, relic_bn_t mu[], char *data, int dlen,
 ...
 * @return a boolean value indicating the verification result.
 */
int cp_mklhs_onv(g1_t sig, relic_bn_t m, relic_bn_t mu[], char *data, int dlen,
