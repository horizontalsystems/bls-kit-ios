 ...
 */
void fp2_exp(fp2_t c, fp2_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp2_exp_cyc(fp2_t c, fp2_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp3_exp(fp3_t c, fp3_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp4_exp(fp4_t c, fp4_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp6_exp(fp6_t c, fp6_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp8_exp(fp8_t c, fp8_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp8_exp_cyc(fp8_t c, fp8_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp9_exp(fp9_t c, fp9_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp12_exp(fp12_t c, fp12_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp12_exp_cyc(fp12_t c, fp12_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp18_exp(fp18_t c, fp18_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp24_exp(fp24_t c, fp24_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp48_exp(fp48_t c, fp48_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp48_exp_cyc(fp48_t c, fp48_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp54_exp(fp54_t c, fp54_t a, relic_bn_t b);
 ...
 * @param[in] b				- the exponent.
 */
void fp54_exp_cyc(fp54_t c, fp54_t a, relic_bn_t b);
